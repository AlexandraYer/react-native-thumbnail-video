    ...
    return (
      ...
      >
        <ImageBackground
          ...
          imageStyle={[{ borderTopRightRadius: 20, borderTopLeftRadius: 20 }, addBottomRadius && { borderBottomRightRadius: 20, borderBottomLeftRadius: 20 }]}
          {...props}
        >
        {
          showPlayIcon ? (
            <Image
              source={playIcon || require('../assets/play.png')}
